...
| `FAILURE_THRESHOLD`             | Number of consecutive failures before switching accounts (`0` to disable). Failures matching `IMMEDIATE_SWITCH_STATUS_CODES` are not counted toward this threshold.                                                                                                   | `3`       |
